...
public class DaftarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftaran);
    ...
    public void onViewClicked() {
        ...
        String passone = textPass1.getText().toString();
        String passtwo = textPass2.getText().toString();

        if (TextUtils.isEmpty(email)) {
            texteMail.setError("Kolom Email Harus di isi!");
        } else if (TextUtils.isEmpty(passone)) {
            textPass1.setError("Password Pertama Harus diisi");

        } else if (TextUtils.isEmpty(passtwo)) {
            textPass2.setError("Password harus di isi sama!");
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()) {
                                Toast.makeText(DaftarActivity.this, "Pendaftaran Gagal",
